...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument('color.image_raw.enable_pub_plugins',default_value='["image_transport/compressed"]'),
        #depth image transport plugins
        DeclareLaunchArgument('depth.image_raw.enable_pub_plugins',default_value='["image_transport/compressedDepth"]'),
        #infra1
        DeclareLaunchArgument('left_ir.image_raw.enable_pub_plugins',default_value='["image_transport/compressed"]'),
        #infra2
        DeclareLaunchArgument('right_ir.image_raw.enable_pub_plugins',default_value='["image_transport/compressed"]'),
    ]
